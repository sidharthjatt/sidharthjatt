...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 5 | 2 hours ago | `Re-export the bundle so the published scoring carries…` |
...
<sub>Auto-refreshed by a GitHub Action · last run 17 Sep 2026, 11:05 UTC</sub>
