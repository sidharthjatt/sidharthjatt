...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 3 | 12 days ago | `Merge pull request #2 from…` |
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | quant backtest thesis | ⭐ 1 | 11 days ago | `Merge pull request #2 from…` |
...
<sub>Auto-refreshed by a GitHub Action · last run 11 Sep 2026, 15:57 UTC</sub>
