...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 3 | 1 hour ago | `Update repo rules: Layer 2 shipped with eight tools and…` |
| [`predictive-engine-s1`](https://github.com/sidharthjatt/predictive-engine-s1) | quant backtest thesis (strategy 1) | ⭐ 2 | 2 days ago | `Add README, known-issues log, and two published figures` |
...
<sub>Auto-refreshed by a GitHub Action · last run 29 Aug 2026, 12:24 UTC</sub>
