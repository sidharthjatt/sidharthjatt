...
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | stock-ranking thesis, NSE | 248 | 2 hours ago |
| [`regret-zero`](https://github.com/sidharthjatt/regret-zero) | decision-regret inventory optimizer | 14 | 6 days ago |

<sub>Auto-refreshed by a GitHub Action · last run 25 Sep 2026, 08:11 UTC</sub>
