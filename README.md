...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 3 | 6 hours ago | `Merge pull request #2 from…` |
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | quant backtest thesis | ⭐ 1 | 13 mins ago | `Merge pull request #1 from…` |
...
<sub>Auto-refreshed by a GitHub Action · last run 30 Aug 2026, 17:31 UTC</sub>
