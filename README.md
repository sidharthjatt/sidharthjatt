...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 5 | 5 hours ago | `Add DESIGN_PASS.md scoping the design pass` |
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | quant backtest thesis | ⭐ 4 | 14 hours ago | `"regenerable with results/hash_58_engine_core.py" was…` |
...
<sub>Auto-refreshed by a GitHub Action · last run 20 Sep 2026, 10:44 UTC</sub>
