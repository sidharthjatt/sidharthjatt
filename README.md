...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 5 | 9 hours ago | `Port the eight tools and the ReAct loop to the browser,…` |
...
<sub>Auto-refreshed by a GitHub Action · last run 17 Sep 2026, 03:43 UTC</sub>
