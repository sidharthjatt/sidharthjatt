...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 3 | 11 hours ago | `Add agent audit layer: tools, eval harness, and five run…` |
