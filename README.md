...
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | 92 | 3 days ago |
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | stock-ranking thesis, NSE | 247 | 12 hours ago |
| [`regret-zero`](https://github.com/sidharthjatt/regret-zero) | decision-regret inventory optimizer | 14 | 8 days ago |

<sub>Auto-refreshed by a GitHub Action · last run 26 Sep 2026, 15:54 UTC</sub>
