...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 5 | 10 hours ago | `Add DESIGN_PASS.md scoping the design pass` |
| [`predictive-engine`](https://github.com/sidharthjatt/predictive-engine) | quant backtest thesis | ⭐ 4 | 19 hours ago | `"regenerable with results/hash_58_engine_core.py" was…` |
| [`regret-zero`](https://github.com/sidharthjatt/regret-zero) | decision-regret inventory optimizer | ⭐ 5 | 2 days ago | `Fix machine reference order in README` |

<sub>Auto-refreshed by a GitHub Action · last run 20 Sep 2026, 15:33 UTC</sub>
