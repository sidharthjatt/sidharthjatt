...
|---|---|---|---|---|
| [`honest-mistake`](https://github.com/sidharthjatt/honest-mistake) | multi-layer ML audit agent | ⭐ 3 | 1 day ago | `Add agent audit layer: tools, eval harness, and five run…` |
| [`predictive-engine-s1`](https://github.com/sidharthjatt/predictive-engine-s1) | quant backtest thesis (strategy 1) | ⭐ 2 | 21 hours ago | `Add README, known-issues log, and two published figures` |
...
<sub>Auto-refreshed by a GitHub Action · last run 28 Aug 2026, 09:53 UTC</sub>
